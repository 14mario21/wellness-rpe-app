// ============================================================
//  CONFIGURACIÓN DE LA PWA — edítala para tu equipo.
// ============================================================
window.APP_CONFIG = {
  // URLs de tus formularios de Google (modo incrustado).
  WELLNESS_URL:
    'https://docs.google.com/forms/d/e/1FAIpQLSdyYhpeqGm4oL2DbRDidwAgSIGNQdy0YhoUHEbRkljQQt8HhQ/viewform?embedded=true',
  RPE_URL:
